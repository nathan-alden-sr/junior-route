...
{
	public class NameAfterRelativeClassNamespaceAndClassNameMapper : INameMapper
	{
		...
		public NameAfterRelativeClassNamespaceAndClassNameMapper(string rootNamespace, bool makeLowercase = false, string wordSeparator = " ", string wordRegexPattern = DefaultWordRegexPattern)
		{

...
{
	public class RelativeUrlResolverFromRelativeClassNamespaceAndClassNameMapper : IRelativeUrlResolverMapper
	{
		...
		public RelativeUrlResolverFromRelativeClassNamespaceAndClassNameMapper(string rootNamespace, bool makeLowercase = true, string wordSeparator = "_", string wordRegexPattern = DefaultWordRegexPattern)
		{

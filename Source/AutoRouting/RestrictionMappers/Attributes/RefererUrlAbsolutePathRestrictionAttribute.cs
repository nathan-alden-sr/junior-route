...
namespace Junior.Route.AutoRouting.RestrictionMappers.Attributes
{
	...
	public class RefererUrlAbsolutePathRestrictionAttribute : RestrictionAttribute
	{
		private readonly string[] _absolutePaths;
		private readonly RequestValueComparer? _comparer;

		public RefererUrlAbsolutePathRestrictionAttribute(string absolutePath, RequestValueComparer comparer)
		{
		...
		public RefererUrlAbsolutePathRestrictionAttribute(params string[] absolutePaths)
		{

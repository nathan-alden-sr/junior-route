...
namespace Junior.Route.AutoRouting.RestrictionMappers.Attributes
{
	...
	public class RefererUrlPathAndQueryRestrictionAttribute : RestrictionAttribute
	{
		...
		public RefererUrlPathAndQueryRestrictionAttribute(params string[] pathsAndQueries)
		{

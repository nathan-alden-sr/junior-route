...
{
	public class BasicProxyAuthorizationHeader
	{
		...
		private BasicProxyAuthorizationHeader(string authScheme, string userid, string password)
		{
		...
		public static BasicProxyAuthorizationHeader Parse(string headerValue)
		{

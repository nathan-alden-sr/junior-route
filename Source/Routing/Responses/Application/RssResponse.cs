...
namespace Junior.Route.Routing.Responses.Application
{
	public class RssResponse : ImmutableResponse
	{
		public RssResponse(Func<byte[]> content, Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss().Content(content), configurationDelegate)
		{
		}

		public RssResponse(Func<byte[]> content, Encoding encoding, Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss().ContentEncoding(encoding).Content(content), configurationDelegate)
		{
		}
		...
		public RssResponse(XmlNode content, Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss().Content(content.GetString()), configurationDelegate)
		{
		}

		public RssResponse(XmlNode content, Encoding encoding, Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss().ContentEncoding(encoding).Content(content.GetBytes(encoding)), configurationDelegate)
		{
		}
		...
		public RssResponse(Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss(), configurationDelegate)
		{
		}

		public RssResponse(Encoding encoding, Action<Response> configurationDelegate = null)
			: base(new Response().ApplicationRss().ContentEncoding(encoding), configurationDelegate)
		{
		}
	}
}
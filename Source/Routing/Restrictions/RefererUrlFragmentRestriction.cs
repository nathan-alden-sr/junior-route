...
namespace Junior.Route.Routing.Restrictions
{
	...
	public class RefererUrlFragmentRestriction : IRestriction, IEquatable<RefererUrlFragmentRestriction>
	{
		...
		public MatchResult MatchesRequest(HttpRequestBase request)
		{
			...
			return _comparer.Matches(_fragment, request.UrlReferrer.Fragment) ? MatchResult.RestrictionMatched(this.ToEnumerable()) : MatchResult.RestrictionNotMatched(Enumerable.Empty<IRestriction>(), this.ToEnumerable());
		}

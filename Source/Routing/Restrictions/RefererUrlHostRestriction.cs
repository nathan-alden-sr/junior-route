...
namespace Junior.Route.Routing.Restrictions
{
	...
	public class RefererUrlHostRestriction : IRestriction, IEquatable<RefererUrlHostRestriction>
	{
		...
		public MatchResult MatchesRequest(HttpRequestBase request)
		{
			...
			return _comparer.Matches(_host, request.UrlReferrer.Host) ? MatchResult.RestrictionMatched(this.ToEnumerable()) : MatchResult.RestrictionNotMatched(Enumerable.Empty<IRestriction>(), this.ToEnumerable());
		}

...
namespace Junior.Route.Routing.Restrictions
{
	...
	public class UrlFragmentRestriction : IRestriction, IEquatable<UrlFragmentRestriction>
	{
		...
		public MatchResult MatchesRequest(HttpRequestBase request)
		{
			...
			return _comparer.Matches(_fragment, request.Url.Fragment) ? MatchResult.RestrictionMatched(this.ToEnumerable()) : MatchResult.RestrictionNotMatched(Enumerable.Empty<IRestriction>(), this.ToEnumerable());
		}

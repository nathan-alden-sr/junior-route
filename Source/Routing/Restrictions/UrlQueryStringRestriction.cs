...
namespace Junior.Route.Routing.Restrictions
{
	...
	public class UrlQueryStringRestriction : IRestriction, IEquatable<UrlQueryStringRestriction>
	{
		...
		public UrlQueryStringRestriction(string field, IRequestValueComparer fieldComparer, string value, IRequestValueComparer valueComparer, bool optional = false)
		{

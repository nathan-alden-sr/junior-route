...
namespace Junior.Route.Routing.Restrictions
{
	...
	public class UrlSchemeRestriction : IRestriction, IEquatable<UrlSchemeRestriction>
	{
		...
		public MatchResult MatchesRequest(HttpRequestBase request)
		{
			...
			return String.Equals(_scheme, request.Url.Scheme) ? MatchResult.RestrictionMatched(this.ToEnumerable()) : MatchResult.RestrictionNotMatched(Enumerable.Empty<IRestriction>(), this.ToEnumerable());
		}

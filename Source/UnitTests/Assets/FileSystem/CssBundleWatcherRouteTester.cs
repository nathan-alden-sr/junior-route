	...
	public static class CssBundleWatcherRouteTester
	{
		...
		public class When_changing_bundle
		{
			...
			public void SetUp()
			{
				...
				_cssBundleWatcherRoute = new CssBundleWatcherRoute("route", _routeId, Scheme.NotSpecified, "relative", _watcher, _httpRuntime, _systemClock);
			}
		...
		public class When_retrieving_css_bundle_response
		{
			...
			public void SetUp()
			{
				...
				_routeId = Guid.NewGuid();
				_watcherRoute = new CssBundleWatcherRoute("route", _routeId, Scheme.NotSpecified, "relative", _watcher, _httpRuntime, _systemClock);

...
{
	public static class DigestProxyAuthorizationHeaderTester
	{
		[TestFixture]
		public class When_parsing_invalid_proxy_authorization_header
		{
			[Test]
			[TestCase("digest")]
			...
			{
				Assert.That(DigestProxyAuthorizationHeader.Parse(headerValue), Is.Null);
			}
		}

		[TestFixture]
		public class When_parsing_valid_proxy_authorization_header
		{
			[Test]
			[TestCase(
			...
			{
				DigestProxyAuthorizationHeader header = DigestProxyAuthorizationHeader.Parse(headerValue);

...
{
	public static class IfModifiedSinceHeaderTester
	{
		[TestFixture]
		public class When_parsing_invalid_if_modified_since_header
		{
			[Test]
			[TestCase("")]
		...
		[TestFixture]
		public class When_parsing_valid_if_modified_since_header
		{
			[Test]
			...
			{
				IfModifiedSinceHeader header = IfModifiedSinceHeader.Parse(headerValue);

...
{
	public static class OptionalCaseInsensitiveRegexRequestTester
	{
		[TestFixture]
		public class When_testing_if_null_value_matches_request_value
		{
			...
			{
				Assert.That(OptionalCaseInsensitiveRegexComparer.Instance.Matches(value, requestValue), Is.True);
			}
		}
	}
}
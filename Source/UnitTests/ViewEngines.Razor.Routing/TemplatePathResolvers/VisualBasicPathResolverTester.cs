...
{
	public static class VisualBasicPathResolverTester
	{
		[TestFixture]
		public class When_resolving_template_path_with_extension
		{
			...
			public void SetUp()
			{
				...
				_resolver = new VisualBasicResolver(_httpRuntime);
			}

			private IHttpRuntime _httpRuntime;
			private VisualBasicResolver _resolver;
		...
		public class When_resolving_template_path_without_extension
		{
			...
			public void Must_resolve_with_default_extension()
			{
				...
				Assert.That(path, Is.EqualTo(@"C:\Test\Templates\Foo.vbhtml"));
			}
		}
	}
}
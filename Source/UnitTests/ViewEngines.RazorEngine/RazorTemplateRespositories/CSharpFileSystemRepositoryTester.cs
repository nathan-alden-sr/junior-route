...
{
	public static class CSharpFileSystemRepositoryTester
	{
		[TestFixture]
		public class When_creating_instance
		{
			...
			public void SetUp()
			{
				...
				new CSharpFileSystemRepository("relative", SearchOption.TopDirectoryOnly, _nameMapper, _fileSystem);
			...
			{
				_fileSystem.AssertWasCalled(arg => arg.GetDirectoryFiles("relative", "*.cshtml", SearchOption.TopDirectoryOnly));
			}
		}
	}
}